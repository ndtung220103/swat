...
class SwatCPS(MiniCPS):
    ...
    def __init__(self, name, net):
        ...
        plc36.cmd(sys.executable + ' -u ' + ' plc36.py  &> logs/plc13.log &')
        plc35.cmd(sys.executable + ' -u ' + ' plc35.py  &> logs/plc12.log &')
        plc34.cmd(sys.executable + ' -u ' + ' plc34.py  &> logs/plc11.log &')
        plc33.cmd(sys.executable + ' -u ' + ' plc33.py  &> logs/plc10.log &')
        plc32.cmd(sys.executable + ' -u ' + ' plc32.py  &> logs/plc16.log &')
        plc31.cmd(sys.executable + ' -u ' + ' plc31.py  &> logs/plc16.log &')
        plc30.cmd(sys.executable + ' -u ' + ' plc30.py  &> logs/plc15.log &')
        plc29.cmd(sys.executable + ' -u ' + ' plc29.py  &> logs/plc14.log &')
        plc28.cmd(sys.executable + ' -u ' + ' plc28.py  &> logs/plc13.log &')
        plc27.cmd(sys.executable + ' -u ' + ' plc27.py  &> logs/plc12.log &')
        plc26.cmd(sys.executable + ' -u ' + ' plc26.py  &> logs/plc11.log &')
        plc25.cmd(sys.executable + ' -u ' + ' plc25.py  &> logs/plc10.log &')
        plc24.cmd(sys.executable + ' -u ' + ' plc24.py  &> logs/plc16.log &')
        plc23.cmd(sys.executable + ' -u ' + ' plc23.py  &> logs/plc16.log &')
        plc22.cmd(sys.executable + ' -u ' + ' plc22.py  &> logs/plc15.log &')
        plc21.cmd(sys.executable + ' -u ' + ' plc21.py  &> logs/plc14.log &')
        plc20.cmd(sys.executable + ' -u ' + ' plc20.py  &> logs/plc13.log &')
        plc19.cmd(sys.executable + ' -u ' + ' plc19.py  &> logs/plc12.log &')
        plc18.cmd(sys.executable + ' -u ' + ' plc18.py  &> logs/plc11.log &')
        plc17.cmd(sys.executable + ' -u ' + ' plc17.py  &> logs/plc10.log &')
